...
dbClient = MongoClient("mongodb+srv://developmentinfayou_db_user:X1O0PcnewGMLWkxN@cluster0.e6ybref.mongodb.net/infa?retryWrites=true&w=majority&appName=Cluster0&tlsAllowInvalidCertificates=true")
# dbClient = MongoClient("mongodb+srv://infayou:HkrflNhX6UxHLSqC@cluster0.zbf0n.mongodb.net/infa?retryWrites=true&w=majority&appName=Cluster0&tlsAllowInvalidCertificates=true")
